#ifndef FIRE_EFFECT2_H
#define FIRE_EFFECT2_H
...
// Advanced Fire Effect 2 - Green Fire
...
public:
  FireEffect2(LEDController* ledController, int segmentLen = 100);
  ~FireEffect2();
